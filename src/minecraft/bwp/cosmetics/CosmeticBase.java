...
public abstract class CosmeticBase implements LayerRenderer<AbstractClientPlayer> {
    ...
    @Override
    public void doRenderLayer(AbstractClientPlayer player, float limbSwing, float limbSwingRight, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
