...
public class GuiErrorLogin extends GuiScreen{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new ClientButtons(0, this.width / 2 - 100, this.height / 4 + 96 + 18, 98, 20, I18n.format("Login", new Object[0])));
        this.buttonList.add(new ClientButtons(1, this.width / 2 - 100, this.height / 4 + 120 + 18, 98, 20, I18n.format("Cancel", new Object[0])));
